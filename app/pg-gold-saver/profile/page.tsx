...
import { PortalGoldJourneyChecklist } from '@/app/pg-gold-saver/_components/PortalGoldJourneyChecklist'
...
type PortalTab = 'details' | 'checklist'
    ...
    <div className="min-h-screen bg-slate-50">
        ...
        <div className="mx-auto flex max-w-lg items-center justify-between px-5 py-4">
          <div>
            ...
            <h1 className="text-lg font-semibold text-slate-900">
              {tab === 'details' ? 'My Details' : 'My Gold Journey Checklist'}
            </h1>
          </div>
          <button
            type="button"
      ...
      <main className="mx-auto max-w-lg px-5 py-6">
        <div
          ...
          className="mb-5 grid grid-cols-2 gap-1 rounded-2xl border border-slate-200 bg-slate-100/90 p-1"
        >
          <button
            type="button"
            role="tab"
            ...
            {customer && (
              <section className="mb-6 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <p className="mt-4 text-xs text-slate-400">
                  PG code and name are managed by your dealer. You can update phone, email, and location
                  below.
                </p>
              </section>
            )}
